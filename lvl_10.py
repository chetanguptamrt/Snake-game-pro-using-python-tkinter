...
def design(obj):
    ...
    obj.create_line(208,8,208,173,width=10,fill='#781414',tag='design')
    obj.create_line(208,254,208,418,width=10,fill='#781414',tag='design')
...
def snake():
    ...
    snake_y=[19,19,19,19,19,19,19,19,19,19]
    turn='RIGHT'
...
def check_condition(snake_x,snake_y):
    if snake_x[0]<1 or snake_y[0]<1 or snake_x[0]>40 or snake_y[0]>40:
        return True
    for i in range(1,17):
        if snake_y[0]==i and snake_x[0]==20:
            return True
