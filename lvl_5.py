...
def design(obj):
    ...
    obj.create_line(218,83,218,343,width=10,fill='#781414',tag='design')
    obj.create_line(83,218,343,218,width=10,fill='#781414',tag='design')

def snake():
    snake_x=[8,7,6,5,4,3,2,1]
    snake_y=[20,20,20,20,20,20,20,20]
    turn='RIGHT'
...
def check_condition(snake_x,snake_y):
    if (snake_x[0]==0 or snake_x[0]==41) and (snake_y[0]==18 or snake_y[0]==19 or snake_y[0]==20 or snake_y[0]==21 or snake_y[0]==22 or snake_y[0]==23):
        ...
        return True
    for i in range(8,34):
        if snake_y[0]==i and snake_x[0]==21:
            return True
    for i in range(8,34):
